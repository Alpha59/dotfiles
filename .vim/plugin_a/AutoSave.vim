...
nnoremap <silent> <K> :call AutoLoad()<CR>
...
if !exists("g:auto_load_events")
  let g:auto_load_events = ["CursorHold"]
endif
...
augroup auto_load
  autocmd!
  for event in g:auto_load_events
    execute "au " . event . " * nested call AutoLoad()"
  endfor
augroup END
