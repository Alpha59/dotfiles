...
* Acceptance Criteria Should either be in `Should have`, `Given/When/Then` syntax or any other Acceptance Criteria format.
...
* It's possible that your templates need to be updated, the most recent templates can always be found at the create issue page
...
For more information on criteria used by SBR, please refer to the Rubric Here.

SBR FB: For Spikes/Mini-designs, use the template to maintain consistency across our stories. The information needed is all here.
